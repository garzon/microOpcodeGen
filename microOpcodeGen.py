...
def calcRel8():
    ...
    callInThisBeat(['mxc0', 'mxc1', 'crdx', 'gt'])
...
def CALL_addr():
    ...
    sendAddr()
    callInThisBeat(['mxc0', 'mxb1', 'cwrx', 'ssp1', 'ob'])
    callInThisBeat(['mxc0', 'mxb0', 'cwrx', 'ssp1', 'ob'])
    callInThisBeat(['mxc1', 'pld1'])
...
def RET():
    ...
    (ADR) --MC=01--> AB --PLD210=101--> PC;'''
    callInThisBeat(['ssp0'])
    callInThisBeat(['mxc0', 'crdx', 'ga2', 'ssp0'])
...
def PUSH():
    ...
    (SP)-1 --SSP=01--> SP;
    '''
    callInThisBeat(['mxc0', 'ob', 'cwrx', 'ssp1'])
