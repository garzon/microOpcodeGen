...
def getOpHelper():
    ...
    (A) --GC=0--> ACT;
    MPLD = 0;
    1110 0000 0011 1111 1111 1111 1101 0111 = E0 3F FF D7
    '''
    # T0:
    callInThisBeat(['mxc0', 'mxc1', 'crdx', 'gi', 'pinc', 'gc', 'mpld'])
...
def sendAddrH():
    ...
    (PC)+1 --PINC=0--> PC;
    1110 1000 0011 1111 1111 1111 1011 1111 = E8 3F FF BF
    '''
...
def sendAddrL():
    ...
    (PC)+1 --PINC=0--> PC;
    1110 1000 0011 1111 1111 1110 1111 1111 = E8 3F FE FF'''
...
def ST():
    ...
    sendAddr()
    callInThisBeat(['mxa', 's2', 'mxb1', 'mxb0', 'cwrx'])
